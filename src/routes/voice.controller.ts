...
const KLOSTERMANN_GREETING_MEDIA_PATH = '/media/klostermann-greeting-v4.wav';
const KLOSTERMANN_GREETING_FILE = resolve(__dirname, '../assets/audio/klostermann-greeting-v4.wav');
