...
const KLOSTERMANN_GREETING_PATH = resolve(__dirname, 'assets/audio/klostermann-greeting-v4.wav');
...
app.get('/media/klostermann-greeting-v4.wav', async (_request, reply) => {
