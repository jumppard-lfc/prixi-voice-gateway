...
const KLOSTERMANN_GREETING_PATH = resolve(__dirname, 'assets/audio/klostermann-greeting-v1.wav');
...
app.get('/media/klostermann-greeting-v1.wav', async (_request, reply) => {
